              ...
              <div class="card-body">
                <form data-id="post-edit-form">
                  ...
                  <div class="form-group">
                    <input type="text" data-id="content-input" class="form-control" id="content-input" placeholder="Что у Вас нового?">
                  </div>
                  <div class="form-group">
          ...
          <div class="card-footer">
            <div class="row">
              ...
              <div class="col text-right">
                <a href="#" data-action="edit" class="btn btn-sm btn-info">Изменить</a>
        ...
        <div class="card">
          <div class="card-body">
           <div class="col text-center">
            <a href="#" data-action="upload-posts" class="btn btn-sm btn-info">Показать еще записи</a>
           </div>
          </div>
        </div>`;
