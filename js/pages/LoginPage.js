                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row"> 
                                    ...
                                    <div class="col-10">
                                        <input type="text" data-id="login-input" class="form-control" placeholder="Введите логин">
                                    </div>
                                </div>
                                <div class="form-group row"> <label class="col-2 col-form-label">Пароль</label>
                                    <div class="col-10">
                                        <input type="password" data-id="password-input" class="form-control" placeholder="Введите пароль"> 
                                    </div>
                                </div>
                        ...
                        <div class="login-links">
                             <p class="text-center" >Нет аккаунта? <a class="txt-brand" href="/register" data-id="register">
                             <font color="#302f30">Зарегистрируйтесь</font></a>
                             </p>
                        </div>
                    </div>
                </div>
